...
package bjfu.BJFU.mall.controller.common;

import bjfu.BJFU.mall.common.Constants;
import bjfu.BJFU.mall.util.SikaMallUtils;
...
public class UploadController {
    ...
    public Result upload(HttpServletRequest httpServletRequest, @RequestParam("file") MultipartFile file) throws URISyntaxException {
        ...
        try {
            ...
            resultSuccess.setData(SikaMallUtils.getHost(new URI(httpServletRequest.getRequestURL() + "")) + "/upload/" + newFileName);
    ...
    public Result uploadV2(HttpServletRequest httpServletRequest) throws URISyntaxException {
        ...
        for (int i = 0; i < multipartFiles.size(); i++) {
            ...
            try {
                ...
                fileNames.add(SikaMallUtils.getHost(new URI(httpServletRequest.getRequestURL() + "")) + "/upload/" + newFileName);
            } catch (IOException e) {
                e.printStackTrace();
                return ResultGenerator.genFailResult("文件上传失败");
            }
